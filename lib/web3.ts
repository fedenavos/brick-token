  ...
  async getProject(projectId: string): Promise<ProjectDetail | null> {
    if (USE_MOCKS) {
      ...
      const mockProject = {
        ...
        actores: {
          emisor: { id: "emisor-001", nombre: "BrickChain Capital", address: "0xabcd..." as const },
          desarrollador: { id: "dev-001", nombre: "Constructora Premium SA", address: "0xefgh..." as const },
          auditor: { id: "audit-001", nombre: "PropTech Auditors", address: "0xijkl..." as const },
        },
        investors: 45,
        hitos: [],
        events: [],
